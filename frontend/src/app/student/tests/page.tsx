...
export default function StudentTestsPage() {
  ...
  return (
    <AuthGuard roles={["student"]}>
      ...
      >
        {/* ── Header ── */}
        <header className="sticky top-0 z-20 bg-[#030409]/80 backdrop-blur-xl border-b border-white/5 px-4 py-4 md:pl-72">
        ...
        {/* ── Content ── */}
        <main className="px-4 py-5 pb-32 md:pl-72 max-w-3xl mx-auto">
          {/* Error */}
          {error && (
